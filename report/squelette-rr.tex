...
improving HPC simulations global efficiency.\\ This work is part of the optimization of I/O
performances of the application called Gysela, a simulation code developped by CEA for the study
of plasma's turbulences in Tokamak, for the study of nuclear fusion. Those simulations produce
large amount of datas and needed regular checkpoints writing, that allow to save the state of the
simulation it can resume it in case of an interruption, whether it is due to a hardware failure or
a limitation on the allotted processing time on supercomputers.
}
%%
